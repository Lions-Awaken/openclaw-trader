...
MANIFEST: list[ManifestEntry] = [
    ...
    ManifestEntry(
        ...
        pipeline_name="catalyst_ingest",
        schedule="15 9 * * 1-5",
        schedule_desc="9:15 AM PDT weekdays",
        expected_steps=[
            "fetch_finnhub",
            "fetch_sec_edgar",
            "fetch_quiverquant",
    ...
    ManifestEntry(
        name="ingest_form4",
        script="scripts/ingest_form4.py",
    ...
    ManifestEntry(
        ...
        script="scripts/ingest_options_flow.py",
        pipeline_name="ingest",
        schedule="0 7 * * 1-5",
    ...
    ManifestEntry(
        ...
        schedule="*/30 6-12 * * 1-5",
        schedule_desc="Every 30m 6:00 AM-12:45 PM PDT weekdays",
        expected_steps=["root"],
        criticality="high",
        output_validator=None,
        freshness_hours=2,
    ...
    ManifestEntry(
        name="meta_daily",
        script="scripts/meta_daily.py",
        pipeline_name="meta_daily",
        schedule="30 13 * * 1-5",
        schedule_desc="1:30 PM PDT weekdays",
        expected_steps=[
            "gather_pipeline_health",
            "gather_signal_accuracy",
            "gather_trades",
            "gather_chain_analysis",
            "gather_catalysts",
            "gather_shadow_divergences",
            "rag_retrieve",
            "generate_reflection",
            "store_reflection",
        ],
    ...
    ManifestEntry(
        ...
        expected_steps=["grade_chains", "update_pattern_templates", "grade_shadows"],
        criticality="medium",
    ...
    ManifestEntry(
        ...
        expected_steps=["check_ollama", "check_tumbler", "update_heartbeat"],
        criticality="low",
